...
public class EasiPosStockersDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public EasiPosStockersDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
