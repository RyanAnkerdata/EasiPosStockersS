...
{
    [DbContext(typeof(EasiPosStockersDbContext))]
    [Migration("20231212082118_Updated_CostCentre_23121210210963")]
    partial class Updated_CostCentre_23121210210963
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasiPosStockers.Branches.Branch", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("EasiPosStockers.CostCentres.CostCentre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EasiPosStockers.CostCentres.CostCentreBranch", b =>
                {
                    ...
                    b.HasKey("CostCentreId", "BranchId");

                    b.HasIndex("BranchId");

                    b.HasIndex("CostCentreId", "BranchId");

                    b.ToTable("AppCostCentreBranch", (string)null);
                });

            modelBuilder.Entity("EasiPosStockers.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EasiPosStockers.Products.ProductCostCentre", b =>
                {
                    ...
                    b.HasKey("ProductId", "CostCentreId");

                    b.HasIndex("CostCentreId");

                    b.HasIndex("ProductId", "CostCentreId");

                    b.ToTable("AppProductCostCentre", (string)null);
                });
            ...
            modelBuilder.Entity("EasiPosStockers.CostCentres.CostCentre", b =>
                {
                    b.HasOne("EasiPosStockers.Branches.Branch", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EasiPosStockers.Products.ProductCostCentre", b =>
                {
                    b.HasOne("EasiPosStockers.CostCentres.CostCentre", null)
                        .WithMany()
                        .HasForeignKey("CostCentreId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("EasiPosStockers.Products.Product", null)
